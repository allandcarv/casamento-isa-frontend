...
const VamosCasar: React.FC<ISectionVamosCasar> = ({ forwardedRef }) => {
  return (
    <StyledSection id="vamos-casar" ref={forwardedRef}>
      ...
      <p>
        Enquanto o grande dia não chega, criamos este site com seções que te
        ...
        compartilhar com você um pouco sobre a nossa história de amor. Está
        começando uma nova e maravilhosa etapa da nossa vida da qual você já faz
        parte.
      </p>

      <p>
        Cada seção tem a sua importância e foi pensada com muito carinho.
