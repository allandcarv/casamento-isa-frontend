  ...
  return (
    <StyledSection id="os-noivos" ref={forwardedRef}>
      ...
      <div className="container">
        ...
        <p>
          Sim, pode parecer um clichê mas eu e Léo temos uma história que
          começou antes de nos conhecermos. Nossas famílias são amigas há muito
          tempo, os avós dele e meus pais trabalhavam juntos em Encontros de
          Casais com Cristo, é como se tudo começasse a ser escrito a partir
          daí.
        </p>
        <p>
          ...
          reaproximamos, tempos depois, os laços de amizade foram se
          construindo, se fortalecendo, e o que vivemos desde então se
          transformou neste amor que cultivamos agora, e pelo qual somos
          imensamente gratos.
        </p>
        <p>
          ...
          transbordou e nos fez sonhar em formar uma família. Uma parte
          importante deste sonho começa agora. E não vemos a hora de
